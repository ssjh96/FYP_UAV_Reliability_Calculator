...
class Page2(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.totals = [None] * 7
        self.final_total = 0
        self.rates[0][0] = 1.24 * pow(10, -4)
        self.rates[0][1] = 7.42 * pow(10, -4)
        self.rates[0][2] = 8.39 * pow(10, -6)
        self.rates[0][3] = 7.61 * pow(10, -6)
        self.rates[1][0] = 6.71 * pow(10, -6)
        self.rates[1][1] = 2.13 * pow(10, -6)
        self.rates[2][0] = 6.19 * pow(10, -6)
        self.rates[3][0] = 5.96 * pow(10, -4)
        self.rates[4][0] = 4.95 * pow(10, -6)
        self.rates[4][1] = 4.95 * pow(10, -6)
        self.rates[5][0] = 8.81 * pow(10, -5)
        self.rates[6][0] = 2.13 * pow(10, -6)
        ...
        self.rate_1_1.setText(f'{self.rates[0][0]:.1e}')
        self.rate_1_2_label.setText('Battery')
        self.rate_1_2.setText(f'{self.rates[0][1]:.1e}')
        self.rate_1_3_label.setText('Electron Speed Regulator')
        self.rate_1_3.setText(f'{self.rates[0][2]:.1e}')
        self.rate_1_4_label.setText('Throttle')
        self.rate_1_4.setText(f'{self.rates[0][3]:.1e}')
        self.rate_1.setText(f'{self.totals[0]:.1e}')
        # 2
        self.rate_2_label.setText('Flight Control System')
        self.rate_2_1_label.setText('Flight Control System')
        self.rate_2_1.setText(f'{self.rates[1][0]:.1e}')
        self.rate_2_2_label.setText('Altitude Measurement Sensor')
        self.rate_2_2.setText(f'{self.rates[1][1]:.1e}')
        self.rate_2.setText(f'{self.totals[1]:.1e}')
        # 3
        self.rate_3_label.setText('Electrical System')
        self.rate_3_1_label.setText('Navigation System')
        self.rate_3_1.setText(f'{self.rates[2][0]:.1e}')
        self.rate_3.setText(f'{self.totals[2]:.1e}')
        # 4
        self.rate_4_label.setText('Communication System')
        self.rate_4_1_label.setText('Communication Link')
        self.rate_4_1.setText(f'{self.rates[3][0]:.1e}')
        self.rate_4.setText(f'{self.totals[3]:.1e}')
        # 5
        self.rate_5_label.setText('Frame')
        self.rate_5_1_label.setText('Arm')
        self.rate_5_1.setText(f'{self.rates[4][0]:.1e}')
        self.rate_5_2_label.setText('Rotor')
        self.rate_5_2.setText(f'{self.rates[4][1]:.1e}')
        self.rate_5.setText(f'{self.totals[4]:.1e}')
        # 6
        self.rate_6_label.setText('Cargo Holds')
        self.rate_6_1_label.setText('Cargo Holds')
        self.rate_6_1.setText(f'{self.rates[5][0]:.1e}')
        self.rate_6.setText(f'{self.totals[5]:.1e}')
        # 7
        self.rate_7_label.setText('Ground Support System')
        self.rate_7_1_label.setText('Remote Control')
        self.rate_7_1.setText(f'{self.rates[6][0]:.1e}')
        self.rate_7.setText(f'{self.totals[6]:.1e}')

        # Total
        self.final_total = sum(self.totals)
        self.input_1.setText(f'{self.final_total:.1e}')
...
class Page3(QtWidgets.QMainWindow):
    ...
    def check_place(self):
        print(self.places_dropdown.currentText())
